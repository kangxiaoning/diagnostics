...
TOOL_LABELS: dict[str, str] = {
    "get_os_system_overview": "获取系统概览",
    "get_os_cpu_info": "分析CPU指标",
    "get_os_mem_5s": "分析内存使用",
    "get_os_block_5s": "分析磁盘IO",
    "get_os_net_ss_s": "分析网络状态",
    "get_os_cpu_ps_elf": "排查进程状态",
    "get_gpu_status_info": "检查GPU健康",
    "get_gpu_status_info": "检查GPU显存",
    "get_gpu_status_info": "分析GPU利用率",
    "check_k8s_control_plane": "检查控制平面",
    "check_k8s_pods": "排查Pod状态",
    "check_k8s_nodes": "检查节点状态",
    ...
    "execute": "执行诊断命令",
    # Live K8s tools
    "get_k8s_cluster_overview": "获取集群概览",
    "get_k8s_pod_logs": "查看Pod日志",
    "describe_k8s_resource": "查看Pod详情",
    "get_k8s_pod_events_info": "查看Pod事件",
    "get_k8s_node_info": "查看节点详情",
    "get_k8s_cluster_events": "查看集群事件",
    "get_k8s_pod_resource_usage": "查看Pod资源使用",
    "get_k8s_node_resource_usage": "查看节点资源使用",
    "get_k8s_pod_logs_since": "查看最近Pod日志",
    "get_k8s_pod_logs_head": "查看Pod日志行数",
    "get_k8s_api_resources": "列出API资源",
    "get_k8s_api_versions": "列出API版本",
    "get_k8s_resource_yaml": "查看资源YAML",
    "explain_k8s_resource": "查看资源字段文档",
    "get_k8s_pod_previous_logs": "查看Pod崩溃前日志",
    "get_k8s_system_pods": "查看系统Pod状态",
    "describe_k8s_controller": "查看控制器详情",
    "check_k8s_service_endpoints": "检查Service端点",
    "get_k8s_configmap": "查看ConfigMap",
    "list_k8s_namespace_resources": "列出命名空间资源",
    "get_k8s_pv_pvc_status": "查看PV/PVC状态",
    "get_k8s_ingress_status": "查看Ingress状态",
    "get_k8s_namespaces": "列出命名空间",
    "get_k8s_coredns_logs": "查看CoreDNS日志",
    "describe_k8s_coredns": "查看CoreDNS详情",
    "list_k8s_helm_releases": "列出Helm部署",
    "get_k8s_helm_release_history": "查看Helm部署历史",
    "get_k8s_helm_release_values": "查看Helm部署参数",
    "get_k8s_node_conditions": "查看节点状态概览",
    "get_k8s_network_policies": "查看网络策略",
    "check_k8s_rbac_permissions": "查看RBAC权限",
    "get_k8s_pod_restart_counts": "查看Pod重启计数",
    "check_k8s_certificate_expiry": "检查证书过期",
    "check_k8s_webhook_status": "检查Webhook配置",
    "get_k8s_etcd_status": "查看etcd状态",
    "get_k8s_etcd_logs": "查看etcd日志",
    "check_k8s_etcd_health": "检查etcd健康",
    "get_k8s_etcd_metrics": "查看etcd指标",
    # Argus dimension-partitioned tools (dedicated/serverless scenes)
    "get_argus_k8s_cluster_metrics": "查询K8s集群指标",
    "get_argus_k8s_node_metrics": "查询K8s节点指标",
    "get_argus_k8s_workload_metrics": "查询K8s工作负载指标",
    "get_argus_k8s_pod_metrics": "查询K8sPod指标",
    "get_argus_k8s_master_metrics": "查询K8s控制面组件指标",
    "get_argus_shared_etcd_metrics": "查询共享etcd指标",
    # Serverless 家族专属补充工具（实际环境 k8s 面无等价语义）
    "get_k8s_apigateway_status": "查看API-Gateway状态",
    "get_k8s_group1_status": "查看Group1隧道状态",
    "get_k8s_ipam_status": "查看IPAM状态",
    "get_k8s_pod_ip": "查看Pod-IP与固定IP",
