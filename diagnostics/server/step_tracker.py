...
TOOL_LABELS: dict[str, str] = {
    ...
    "query_argus_k8s_cluster": "查询K8s集群指标",
    "query_argus_k8s_node": "查询K8s节点指标",
    "query_argus_k8s_workload": "查询K8s工作负载指标",
    "query_argus_k8s_pod": "查询K8sPod指标",
    "query_argus_k8s_etcd": "查询K8s-etcd指标",
    "query_argus_serverless_cluster": "查询逻辑集群指标",
    "query_argus_serverless_node": "查询逻辑集群节点指标",
    "query_argus_serverless_workload": "查询逻辑集群负载指标",
    "query_argus_serverless_pod": "查询逻辑集群Pod指标",
    "query_argus_shared_etcd": "查询共享etcd指标",
    "query_argus_kmc_cluster": "查询KMC集群指标",
    "query_argus_kmc_node": "查询KMC节点指标",
    "query_argus_kmc_workload": "查询KMC工作负载指标",
    "query_argus_kmc_pod": "查询KMCPod指标",
    "query_argus_kmc_etcd": "查询KMC-etcd指标",
    "query_argus_sci_cluster": "查询SCI集群指标",
    "query_argus_sci_node": "查询SCI节点指标",
    "query_argus_sci_workload": "查询SCI工作负载指标",
    "query_argus_sci_pod": "查询SCIPod指标",
    "query_argus_sci_etcd": "查询SCI-etcd指标",
    # Serverless deep-expert tools
    "get_serverless_deployments": "查看逻辑集群Deployment",
    "get_serverless_pods": "查看逻辑集群Pod",
    "get_serverless_pod_logs": "查看逻辑集群Pod日志",
    "get_serverless_events": "查看逻辑集群事件",
    "get_kmc_deployments": "查看KMC-Deployment",
    "get_kmc_pods": "查看KMC-Pod",
    "get_kmc_pod_logs": "查看KMC-Pod日志",
    "get_kmc_events": "查看KMC事件",
    "get_kmc_etcd_status": "查看KMC-etcd状态",
    "get_kmc_apigateway_status": "查看API-Gateway状态",
    "get_kmc_group1_status": "查看Group1隧道状态",
    "get_kmc_ipam_status": "查看IPAM状态",
    "get_kmc_vpc_cni_controller_status": "查看vpc-cni-controller状态",
    "get_sci_nodes": "查看SCI节点",
    "get_sci_pods": "查看SCI-Pod",
    "get_sci_pod_logs": "查看SCI-Pod日志",
    "get_sci_events": "查看SCI事件",
