...
def query_argus_cpu() -> str:
    ...
    """
    return query_argus_cpu_metrics(get_active_scenario())


@tool
def query_argus_memory() -> str:
    ...
    """
    return query_argus_memory_metrics(get_active_scenario())


@tool
def query_argus_disk() -> str:
    ...
    """
    return query_argus_disk_metrics(get_active_scenario())


@tool
def query_argus_network() -> str:
    ...
    """
    return query_argus_network_metrics(get_active_scenario())


@tool
def query_argus_kubernetes() -> str:
    ...
    """
    return query_argus_k8s_metrics(get_active_scenario())
